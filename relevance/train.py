...
from PropCare_new import Causal_Model as Causal_Model_New
from PropCare_old import Causal_Model as Causal_Model_Old
...
def prepare_data(flag):
    ...
    if dataset == "d":
        ...
        data_path = Path("/dunn_cat_mailer_10_10_1_1/1week/original_rp0.40")
    elif dataset == "p":
        print("dunn_cate (personalized) is used.")
        data_path = Path("/dunn_cat_mailer_10_10_1_1/1week/rank_rp0.40_sf1.00_nr210")
